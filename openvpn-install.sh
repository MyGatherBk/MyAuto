...
END
	...
	echo "<pre>by Ekkachai Chompoowiset | Donate via TrueMoney Wallet : 097-206-5255</pre>" > /home/vps/public_html/index.html
...
END
	...
	wget -O /usr/local/bin/Auto-Delete-Client "https://raw.githubusercontent.com/ZENON-VPN/ZENON-AUTO-VPN/master/Auto-Delete-Client"
