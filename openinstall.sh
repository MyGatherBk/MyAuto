#!/bin/bash
#
# https://www.facebook.com/pirakit.khawpleum/



# Detect Debian users running the script with "sh" instead of bash
if readlink /proc/$$/exe | grep -q "dash"; then
	echo 'โปรแกรมติดตั้งนี้จะต้องรันด้วย "bash", not "sh".'
	exit
fi
...
chmod +x /usr/local/bin/m
	...
	echo ""
	echo "===================================================================="
	echo "ติดตั้งสำเร็จ... กรุณาพิมพ์คำสั่ง${YELLOW} m ${NC} เพื่อไปยังขั้นตอนถัดไป"
	echo "===================================================================="
	echo ""
	exit
